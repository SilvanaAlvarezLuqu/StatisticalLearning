...
library(reshape)
library(tidyverse)
model_image_1= readRDS("model1.rds")
model_image_2= readRDS("model2.rds")
...
# saveRDS(model_image_1, file = "model1.rds")
# saveRDS(model_image_2, file = "model2.rds")
# saveRDS(model_image_3, file = "model3.rds")
